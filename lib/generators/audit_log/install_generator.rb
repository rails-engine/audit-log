  ...
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_initializer
        ...
        template 'app/views/audit_log/logs/index.html.erb.tt', 'app/views/audit_log/logs/index.html.erb'
        template 'app/views/audit_log/logs/show.html.erb.tt', 'app/views/audit_log/logs/show.html.erb'
        template 'app/views/layouts/audit-log/application.html.erb.tt', 'app/views/layouts/audit-log/application.html.erb'
      end
