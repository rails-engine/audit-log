...
class AuditLogTest < ActiveSupport::TestCase
  ...
  test "action_options" do
    assert_equal [["List Audit Log", "list_audit_log"], ["Create Audit Log", "create_audit_log"], ["Update Audit Log", "update_audit_log"], ["Update Password", "update_password"], %w[Hello1 hello], ["Visit Home", "home"]],
                 AuditLog.action_options
  end
end
